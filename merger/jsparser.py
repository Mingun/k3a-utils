...
class Tokenizer(object):
    ...
    @property
    def input_(self): return self.source[self.cursor:]
    @property
    def done(self): return self.peek() == END
    @property
    def token(self): return self.tokens.get(self.tokenIndex)
...
class Node(list):
    ...
    def __init__(self, t, type_=None, args=[]):
        ...
        for arg in args:
            self.append(arg)
    @property
    def type(self): return tokenstr(self.type_)
    ...
    def __str__(self):
        ...
        for attr in dir(self):
            if attr[0] == "_": continue
                ...
                a.append((attr, '[parent %s]'%getattr(self, attr).value))
    ...
    @property
    def filename(self): return self.tokenizer.filename
